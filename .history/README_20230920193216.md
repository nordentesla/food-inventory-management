...
1. **Edit or Remove an Item** - prompts the user for option number that is displayed in the current inventory
    1. Items displayed
    1. ...
    1. ... **Cancel Item Edit/Remove** - goes back to current **Inventory Menu**
1. **Edit an Item** - prompts the user for option number that is displayed in the current inventory
    1. Items displayed
    1.
1. **Export as PDF**
